...
const ContactForm = dynamic(() => import('@/components/react-bits/ContactForm'), {
  ssr: true,
  loading: () => <Loading text="Loading Contact Form..." variant="dots" />
})
...
export default function Contact() {
  return (
    <>
      <Head>
        <title>Contact Us - React Bits Portfolio</title>
        <meta name="description" content="Get in touch with our creative web agency. Let's discuss your next project and bring your vision to life." />
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6 text-purple-200">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>hello@reactbitsagency.com</span>
                  </div>
                ...
                <div className="pt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="w-10 h-10 bg-purple-600 hover:bg-purple-700 rounded-full flex items-center justify-center transition-colors duration-200">
